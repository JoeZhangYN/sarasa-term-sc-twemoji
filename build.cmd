...
:: 5. patch Twemoji -> aligned advance + UPM 1000
echo [build] patching Twemoji to aligned advance...
python patch_emoji_only.py downloads\TwemojiMozilla.ttf output\TwemojiAligned-Regular.ttf "Twemoji Aligned" || goto :fail
